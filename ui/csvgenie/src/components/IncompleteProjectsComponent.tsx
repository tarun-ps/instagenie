...
const IncompleteProjectsComponent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await fetch(`${backendUrl}/projects/incomplete`);
    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="mx-auto w-full min-w-[800px] flex flex-wrap gap-4 justify-center">
        ...
        {projects && projects.map((project) => (
          <div key={project.id} className="w-[200px] h-[150px]">
            <Card className="h-full">
              <CardHeader>
                <CardTitle className="text-center">
                  {project.metadata.preliminary_analyse.domain || "Untitled"}
                </CardTitle>
                <br />
...
export default IncompleteProjectsComponent; 